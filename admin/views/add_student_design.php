			...
			<form method="POST" action="">
				...
				<div class="form-group row">
					...
					<div class="col-sm-8">
						...
						<label>Male</label>
						<input type="radio" class="ml-2" value="F" name="gender">
						<label>Female</label>
					</div>
				</div>
				...
				<div class="form-group row">
					<label class="col-sm-4 col-form-label">Course<span class="text-danger font-weight-bold">&nbsp;*</span></label>
					<div class="col-sm-8">
				...
				<div class="form-group row">
					<label class="col-sm-4 col-form-label">Level<span class="text-danger font-weight-bold">&nbsp;*</span></label>
					<div class="col-sm-8">
